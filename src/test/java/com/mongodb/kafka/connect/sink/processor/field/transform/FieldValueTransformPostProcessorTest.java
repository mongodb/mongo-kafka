...
class FieldValueTransformPostProcessorTest {
    ...
    void testTransformsConfiguredFields() {
        ...
        FieldValueTransformPostProcessor processor = new FieldValueTransformPostProcessor(createTopicConfig(json));
    ...
    void testTransformsFieldsInArrays() {
        ...
        BsonDocument valueDoc = BsonDocument.parse(
    ...
    void testTransformsDeeplyNestedFields() {
        ...
        BsonDocument valueDoc = BsonDocument.parse("{'level1': {'level2': {'level3': {'target': 'deep'}}}}");
        SinkDocument sinkDoc = new SinkDocument(null, valueDoc);
