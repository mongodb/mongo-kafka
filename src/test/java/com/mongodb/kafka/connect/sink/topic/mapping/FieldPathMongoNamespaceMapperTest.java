...
package com.mongodb.kafka.connect.sink.topic.mapping;
...
public class FieldPathMongoNamespaceMapperTest {
  ...
  private static final SinkRecord SINK_RECORD =
      new SinkRecord(
          ...
          "{'db': 'dbKey', 'coll': 'collKey', 'invalid': 1}",
          Schema.STRING_SCHEMA,
          "{'db': 'dbValue', 'coll': 'collValue', 'invalid': 1}",
          1);
  ...
  private MongoNamespaceMapper createMapper(final MongoSinkTopicConfig config) {
    MongoNamespaceMapper namespaceMapper = new FieldPathMongoNamespaceMapper();
