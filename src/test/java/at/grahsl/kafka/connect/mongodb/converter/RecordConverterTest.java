...
public class RecordConverterTest {
    ...
    public static BsonDocument EXPECTED_BSON_DOC_BASE64_1;
    ...
    public static void initializeTestData() {
        ...
        EXPECTED_BSON_DOC_BASE64_1 = EXPECTED_BSON_DOC_BYTES_1.clone();
        EXPECTED_BSON_DOC_BASE64_1.replace("myBytes",new BsonString("S2Fma2Egcm9ja3Mh"));
    ...
    public void testJsonRawStringConversion() {
        ...
        assertAll("",
                () -> assertEquals(EXPECTED_BSON_DOC_BASE64_1, converter.convert(null, JSON_STRING_1)),
