...
abstract class AbstractTopicMapper implements TopicMapper {
  ...
  protected Document topicNamespaceMap;
  ...
  private String getTopicNameFromNamespaceMap(
    ...
    return getAltTopicNameFromNamespaceMap(namespace, dbName, collName);
  }

  protected abstract String getAltTopicNameFromNamespaceMap(
      final String namespace, final String dbName, final String collName);
}
