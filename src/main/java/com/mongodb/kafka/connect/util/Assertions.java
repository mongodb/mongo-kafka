...
/**
 * All {@code assert...} and {@code fail} methods throw {@link AssertionError} and should be used to
 * check conditions which may be violated if and only if the driver code is incorrect. The intended
 * usage of these methods is the same as of the <a
